...
% Tabela de resultados a ser inserida
...
% Tabela de tempos a ser inserida

\section{Análise dos Resultados}

A análise comparativa dos três algoritmos considera qualidade da solução e tempo de execução. O algoritmo guloso oferece soluções rápidas mas de qualidade inferior. O randomizado melhora a qualidade através de múltiplas iterações, enquanto o reativo adapta automaticamente o parâmetro $\alpha$ para cada instância.

\section{Conclusão}

Os experimentos demonstraram a eficácia das heurísticas GRASP para o problema L(p,q)-coloring. O algoritmo reativo apresentou os melhores resultados em termos de qualidade de solução, enquanto o guloso é adequado quando o tempo de execução é crítico.
